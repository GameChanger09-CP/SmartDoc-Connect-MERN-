...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 flex flex-col items-center justify-center p-6 font-sans">
      ...
      {/* 3-Role Selection Grid (Removed Vendor) */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl">
        ...
        >
          ...
          <p className="text-blue-200 text-sm">Review incoming files, submit reports, and manage department workflow.</p>
        </div>
        ...
        >
          ...
          <p className="text-red-200 text-sm">System oversight, routing control, analytics, and security audits.</p>
        </div>
